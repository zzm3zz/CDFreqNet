...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='CDFreqNet Testing Function')

    parser.add_argument('--weight_path', default='./checkpoints/best_source_val_model.pth')
    parser.add_argument('--test_dir', default='./data/target/test/')
